...
const SKILL_GROUPS = [
  ...
  },
  {
    ...
    color: "#22D3EE",
    skills: ["React.js", "Next.js", "Redux Toolkit", "Context API", "React Hooks", "React Router", "jQuery"],
  },
  {
    category: "Styling & UI",
    color: "#10B981",
    skills: ["Tailwind CSS", "Material-UI", "Styled-Components", "CSS-in-JS", "Sass"],
  },
  {
    category: "Animation & Realtime",
    color: "#F59E0B",
    skills: ["GSAP", "Framer Motion", "Three.js / R3F", "Lottie", "CSS Animations", "WebSocket"],
  },
  {
    category: "Testing & Tooling",
    color: "#EC4899",
    skills: ["Jest", "React Testing Library", "Vite", "Webpack", "ESLint", "Prettier", "Postman", "Axios"],
  },
  {
